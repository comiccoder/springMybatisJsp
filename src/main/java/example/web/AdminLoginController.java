...
public class AdminLoginController
{
    ...
    /******************************************
     ////***login相关
     *****************************************/
    @RequestMapping(value="noAuth/adminLogin",method = RequestMethod.GET)
    public String login()
    {
        return "noAuth/adminLogin";
    }   //
    ...
    //采用jsson的方式，，如果出错
    @ResponseBody
    @RequestMapping(value="noAuth/adminLogin",method = RequestMethod.POST )
